      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-50 max-w-md mx-auto p-6 rounded-t-[36px] bg-[#0b0f19]/90 border-t border-white/[0.08] backdrop-blur-2xl shadow-[0_-12px_40px_rgba(0,0,0,0.5)]"
          >
            {/* Drawer Bevel Handle */}
